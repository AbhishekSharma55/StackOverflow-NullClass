...
const Tags = () => {
  const Tags = [
    ...
    },
    {
      tag: "python",
      description:
        "Python is a versatile high-level programming language for general-purpose programming.",
    },
    {
      tag: "java",
      description:
    ...
    },
    {
      tag: "angular",
      description:
        "Angular is a platform for building mobile and desktop web applications, developed and maintained by Google.",
    },
    {
      tag: "vue.js",
      description:
        "Vue.js is a progressive framework for building user interfaces, focusing on incremental adoption.",
    },
    {
      tag: "django",
      description:
    ...
    },
    {
      tag: "kotlin",
      description:
        "Kotlin is a modern, statically typed programming language that runs on the Java Virtual Machine (JVM) and is fully interoperable with Java.",
    },
    {
      tag: "go",
      description:
    ...
    },
    {
      tag: "typescript",
      description:
        "TypeScript is a strongly typed, object-oriented, compiled language that builds on JavaScript, giving you better tooling at any scale.",
    },
    {
      tag: "mongodb",
      description:
    ...
    },
    {
      tag: "numpy",
      description:
        "NumPy is the fundamental package for scientific computing with Python, providing support for large multi-dimensional arrays and matrices.",
    },
    {
      tag: "scikit-learn",
      description:
  ...
  return (
    <div className="p-5 min-h-full overflow-hidden">
      ...
      <div className="flex flex-wrap gap-4 m-10">
        {Tags.map((tag) => {
          return (
            <div
              key={tag.tag}
              className="border border-gray-400 h-50 w-40 rounded-xl"
            >
